...
\author[1]{Cambridge First Author\hyperlink{corr}{*}}
\address[1]{Electronic Products and Composition Group, Printing Division, Cambridge University Press, CB2 2BS}

\author[2]{Cambridge Second Author}
\address[2]{Department of Innovation Engineering, University of Salento - ISME node - Lecce, Italy.}
\address{\hypertarget{corr}{*}Corresponding author. \email{roberta.ingrosso@unisalento.it}}
