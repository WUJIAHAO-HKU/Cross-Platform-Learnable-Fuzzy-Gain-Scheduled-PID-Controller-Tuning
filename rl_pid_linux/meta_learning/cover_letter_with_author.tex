...
% Author information (for use after paper acceptance)
...
On behalf of all co-authors, I am pleased to submit our manuscript entitled \textbf{``Adaptive PID Control for Robotic Systems via Hierarchical Meta-Learning and Reinforcement Learning with Physics-Based Data Augmentation''} for consideration for publication in \textit{Robotics and Autonomous Systems}.
...
\section*{Relevance to Robotics and Autonomous Systems}
...
\begin{itemize}
\item \textbf{Jiahao Wu} (Corresponding Author): Conceptualization, Methodology, Software, Validation, Writing - Original Draft, Visualization
\item \textbf{Shengwen Yu}: Validation, Writing - Review \& Editing, Data Curation
\end{itemize}
...
\item \textbf{Data Availability}: All code and data are available at: \url{https://github.com/WUJIAHAO-HKU/rl-mpc-meta-learning}
